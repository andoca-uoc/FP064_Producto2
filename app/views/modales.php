...
<div class="modal fade" id="crearPonenteoModal" tabindex="-1" aria-labelledby="crearPonenteModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
			...
			<div class="modal-body">
				<form action="../controllers/ponente/crear.php" method="POST">
					<div class="container mt-4">
...
<div class="modal fade" id="modalActualizarPonente" tabindex="-1" aria-labelledby="modalActualizarPonente" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form id="formActualizarPonente" method="POST" action="/controllers/ponente/actualizar.php">
