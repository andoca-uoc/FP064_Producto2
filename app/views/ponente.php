							...
							<?php foreach ($ponentes as $ponente) : ?>
								<tr id="ponente-<?php echo $ponente['iduser']; ?>">
									...
									<td>
										...
										<div class="btn-group" role="group">
											<a role="button" class="btn btn-sm btn-outline-danger" href="#" onclick="confirmarEliminacionPonente('../controllers/ponentes/borrar.php?id=<?php echo $ponente['iduser']; ?>')">Borrar</a>
										</div>
									</td>
								</tr>
							<?php endforeach ?>
